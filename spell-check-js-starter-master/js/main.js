...
function ch1Linear() {
  let NoOfMissingWords = 0;
  for(let i =0; i <= aliceWordsCh1.length - 1; i++)
  {
    let searchResult = linearSearch(dictionary, aliceWordsCh1[i]);
if (searchResult == -1)
{
  NoOfMissingWords++;
  ...
  document.getElementById("ch1-result").innerHTML = "Words missing: " + NoOfMissingWords ;
}
...
function ch1Binary() {
  ...
  for(let i =0; i <= aliceWordsCh1.length - 1; i++)
  {
    let searchResult = binarySearch(dictionary, aliceWordsCh1[i]);
if (searchResult == -1)
{
  NoOfMissingWords++;
  console.log(aliceWordsCh1[i]);
...
function fullLinear() {
  let NoOfMissingWords = 0;
  for(let i =0; i <= aliceWordsFull.length - 1; i++)
  {
    let searchResult = linearSearch(dictionary, aliceWordsFull[i]);
if (searchResult == -1)
{
  NoOfMissingWords++;
  ...
  document.getElementById("full-result").innerHTML = "Words missing: " + NoOfMissingWords ;
}
...
function fullBinary() {
  ...
  for(let i =0; i <= aliceWordsFull.length - 1; i++)
  {
    let searchResult = binarySearch(dictionary, aliceWordsFull[i]);
if (searchResult == -1)
{
  NoOfMissingWords++;
  console.log(aliceWordsFull[i]);
